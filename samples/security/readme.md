...
* `create-jira-ticket-for-verified-host-vulnerabilities.yaml` - Jira ticket creation for critical and high severity vulnerabilities on hosts that were confirmed to be monitored by Dynatrace.
